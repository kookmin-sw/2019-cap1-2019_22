...
#for i, label in enumerate (["walk", "stand"]): #modified - up might need to be obmitted in the future
for i, label in enumerate (["walk", "stand", "empty"]): #modified - up might need to be obmitted in the future
#for i, label in enumerate(["LEE"]):  # modified - up might need to be obmitted in the future
	filepath1 = "./Dataset/0502test_*" + str(label) + "*.csv"
	#filepath1 = "./Dataset/0502test*" + "*.csv"
	filepath2 = "./Dataset/annotation_LEE_*" + str(label) + "*.csv"
	#filepath2 = "./Dataset/annotation_LEE_*" + "*.csv"
